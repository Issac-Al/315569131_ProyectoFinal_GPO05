...
glm::vec3 directionlight(0.0f, 0.5f, 5.0f);
...
int main()
{
	...
	Model Modelo((char*)"Models/Fachada/Fachada.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.specular"),3.0f, 3.0f, 3.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].specular"), 3.0f, 3.0f, 3.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), directionlight.x, directionlight.y, directionlight.z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 0.5, 0.5f, 0.5f);
